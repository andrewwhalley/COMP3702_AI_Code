...
public class TrackerTest {
	...
	public void testTracker() {
		...
		Tracker tracker = new Tracker(1, p, h1, tsp, targetInitialStates, h2, tsp, a, obstacles, null);
		pm.update(previousResult, scores, newPercepts);
		System.out.println(tracker.getAction(0, previousResult, scores, newPercepts).getResultingState());
